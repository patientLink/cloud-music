...
export const SET_SHOW_COMMENTS_LIST = 'player/SET_SHOW_COMMENTS_LIST';
export const DELETE_SONG = 'player/DELETE_SONG';
export const INSERT_SONG = 'player/INSERT_SONG';
export const INSERT_NEXT_SONG = 'player/INSERT_NEXT_SONG';
export const CHANGE_FM_MODE = 'player/CHANGE_FM_MODE'